    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div class="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                <p><strong>Super Admin:</strong> super@test.com / superadmin123</p>
                <p><strong>Regular Admin:</strong> admin@test.com / admin123</p>
            </div>
        </div>
        ...
        <!-- Admin Login Form -->
        <form class="space-y-6" action="/admin/login" method="POST" id="admin-login-form">
            <div class="space-y-4">
                <div>
            ...
            <div class="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <a href="/admin/register" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 text-sm">
                    Sign up
                </a>
            </div>
        ...
        <!-- Hidden super-admin form — posts to the correct route -->
        <form id="superadmin-login-form" action="/superadmin/login" method="POST" style="display:none;">
            <input type="hidden" name="email" id="sa-email">
            <input type="hidden" name="password" id="sa-password">
        </form>
    </div>
</div>
...
function quickSuperAdminLogin() {
    document.getElementById('sa-email').value    = 'super@test.com';
    document.getElementById('sa-password').value = 'superadmin123';
    document.getElementById('superadmin-login-form').submit();
}
