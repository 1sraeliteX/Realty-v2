...
$pageTitle = 'Edit Financial Transaction';
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">Update financial transaction information</p>
            </div>
    ...
    <!-- Form -->
    <form method="POST" action="/admin/finances/<?php echo $_GET['id'] ?? '1'; ?>" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                        <option value="rental_income" selected>Rental Income</option>
                ...
                <div>
                    ...
                    <input type="date" name="transaction_date" value="2024-03-01" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                </div>
                <div>
            ...
            <div class="mt-6">
                ...
                <input type="text" name="description" value="Rent Collection - Unit 101" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
            </div>
            <div class="mt-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Notes</label>
                <textarea name="notes" rows="4" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white">Monthly rent payment from John Doe</textarea>
            </div>
        </div>
