...
/* List mode: 2x2 grid adjustments */
.property-card.list-mode .grid.grid-cols-2 {
    grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
    gap: 0.375rem !important;
}
.property-card.list-mode .grid.grid-cols-2 a,
.property-card.list-mode .grid.grid-cols-2 button {
    padding: 0.375rem 0.5rem !important;
    font-size: 0.7rem !important;
}
.property-card.list-mode .grid.grid-cols-2 i {
    display: none !important;
}
        ...
        <?php foreach ($properties as $property): ?>
            ...
            <div class="property-details p-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <!-- View Details -->
                    <a href="/admin/properties/<?php echo $property['id']; ?>" class="flex items-center justify-center px-3 py-2 bg-primary-600 text-white text-sm font-medium rounded-lg hover:bg-primary-700 transition-colors">
                        <i class="fas fa-eye mr-1.5 text-xs"></i>
                        View Details
                    </a>
                    <!-- Units -->
                    <button onclick="viewUnits(<?php echo $property['id']; ?>)" class="flex items-center justify-center px-3 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-door-open mr-1.5 text-xs"></i>
                        Units
                    </button>
                    <!-- Edit -->
                    <button onclick="editProperty(<?php echo $property['id']; ?>)" class="flex items-center justify-center px-3 py-2 border border-blue-300 dark:border-blue-600 text-blue-600 dark:text-blue-400 text-sm font-medium rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                        <i class="fas fa-edit mr-1.5 text-xs"></i>
                        Edit
                    </button>
                    <!-- Delete -->
                    <button onclick="deleteProperty(<?php echo $property['id']; ?>)" class="flex items-center justify-center px-3 py-2 border border-red-300 dark:border-red-600 text-red-600 dark:text-red-400 text-sm font-medium rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
